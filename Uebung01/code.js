...
let experiment_configuration_function = (writer) => {
    return {
        ...
        introduction_pages: writer.stage_string_pages_commands([
            ...
            writer.convert_string_to_html_string(
                "Your goal is to calculate the correct final price based on given parameters. The variable names may be descriptive or abbreviated. Try to remember each calculation. You should have a calculator near you.")
        ]),
        ...
        task_configuration: (t) => {
            let names = t.treatment_combination[0].value;
           ...
           function getRandomFloat(min, max) {
            ...
            if (names === "descriptive_names") {
                let basePrice = getRandomInt(1, 10);
                let discount = [0.1, 0.2, 0.5][Math.floor(Math.random() * 3)];
            ...
            if (names === "short_names") {
                ...
                let b = [0.1, 0.2, 0.5][Math.floor(Math.random() * 3)];
